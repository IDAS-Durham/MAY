"""Private household-promotion allocation functions."""
...
def promote_and_allocate(
    ...
    for category_name in target_categories:
        ...
        for geo_unit_code, pools in self.person_pool_by_geo_unit.items():
                ...
                if can_add > 0:
                    ...
                    for pid in ids_to_take:
                        ...
                        household.add_to_subset(
                            person,
                            subset_key=self._get_person_category_name(person),
                        )
