...
class GeographicalUnit:
    ...
    def __init__(self, id, name, level, coordinates=None, parent=None, properties=None):
        ...
        self.people = (
            []
        )  # List of people in this geographical unit (populated at smallest level)
        self.properties = (
            properties if properties is not None else {}
        )  # Extensible dict for any additional data
    ...
    def __eq__(self, other) -> bool:
        ...
        if self.id != other.id or self.name != other.name or self.level != other.level:
            return False
        ...
        elif self.parent.id != other.parent.id or self.parent.name != other.parent.name:
