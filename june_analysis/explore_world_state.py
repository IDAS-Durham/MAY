"""
Explore world_state.h5 file structure

This script explores the world_state.h5 file generated by the Python world creation scripts
in june_zero (create_world.py). This is different from simulation_events.h5 which contains
simulation results from the june2 C++ simulator.

Expected structure:
  /geography/ - geographical units, hierarchy
  /population/ - people data sorted by geo_unit_id
  /venues/ - venue data sorted by geo_unit_id
  /relationships/activity_map/ - person-to-venue activity mappings
"""
