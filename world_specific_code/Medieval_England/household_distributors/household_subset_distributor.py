...
class HouseholdSubsetDistributor(SubsetDistributor):  
    ...
    def find_subset_for_person(self,
        ...
        Args:
          activity (str): the label for the type of activity the person is being sent to do. 
        ...
        Returns:
          (int):
            The index of the assigned subset in the list of subsets (should be the same as the index of the subset when the contact matrix is built). 
          subset_name (str):
            The label of the subset within the Venue that the Person should be assigned to (pending capacity). Returns "No subset available" if no subset is available for the person at the venue. 
