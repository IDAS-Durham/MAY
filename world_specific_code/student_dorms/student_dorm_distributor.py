...
class StudentDormDistributor(DistributorMultiPass):
    ...
    def _assign_subsets(self):
        ...
        self.subset_distributor = StudentDormSubsetDistributor(
            self.venue_type,
            StudentDormDistributor.age_categories,
        )
    ...
    def _update_venue_membership_capacity(self, trial_venue_index, venue, *args, **kwargs):
        ...
        """
        for i, subset_name in enumerate(StudentDormDistributor.age_categories):
